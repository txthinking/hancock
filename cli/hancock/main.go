...
func main() {
	cli.HelpPrinter = func(w io.Writer, templ string, data interface{}) {
		...
		fmt.Println("")
		fmt.Println("Run command and wait output on a instance")
		fmt.Println("")
		fmt.Println("    $ hancock mylinux echo hello")
		fmt.Println("    $ hancock mylinux sleep 3 '&&' echo hello")
		fmt.Println("")
		fmt.Println("Start command and do not wait output on a instance")
		fmt.Println("")
